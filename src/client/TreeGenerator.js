...
var TreeGenerator = function(canopies, height, trunkMaterial, leafMaterial, scene) {
    ...
    var trunk = BABYLON.Mesh.CreateCylinder("trunk", nbS, nbL*1.5 - nbL/2 - 1, nbL*1.5 - nbL/2 - 1, 12, 1, scene);
